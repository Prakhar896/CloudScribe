    ...
    <div className="flex flex-col h-screen w-full bg-zinc-950 text-white">
        ...
        {!isEditing && (
          <div className="flex space-x-2">
            <button
              ...
              className="p-2 bg-zinc-800 hover:bg-zinc-700 rounded-md transition-colors text-zinc-300"
              title="Edit Note"
            >
      ...
      {isEditing ? (
        <form onSubmit={handleUpdate} className="flex flex-col flex-1 p-4 space-y-4 overflow-hidden">
          <div className="shrink-0">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-white text-base"
              autoFocus
            />
          </div>
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <textarea
              ...
              className="flex-1 w-full p-3 bg-zinc-900 border border-zinc-800 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-white resize-none text-sm leading-relaxed"
            />
          </div>
          <div className="shrink-0">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-white text-xs"
            />
          </div>
        ...
        <main className="flex-1 overflow-y-auto p-5 relative">
          <h2 className="text-2xl font-bold text-zinc-100 mb-2">{note.title}</h2>

          <div className="flex flex-wrap gap-2 mb-6">
            {note.tags?.map((tag, i) => (
              <span key={i} className="text-xs px-2 py-1 bg-zinc-800 text-zinc-300 rounded-md border border-zinc-700">
                #{tag}
              </span>
            ))}
          </div>
